        ...
        <div>
            ...
            <Accordion defaultActiveKey="0">
                <Accordion.Item eventKey="0">
                    <Accordion.Header>এই কোর্স শুরু করার আগে কি কি পূর্ব প্রস্তুতি থাকা দরকার ?</Accordion.Header>
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="1">
                    <Accordion.Header>এই কোর্স গুলো শিক্ষাকতা যোগ্যতা কেমন হওয়া লাগবে?</Accordion.Header>
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="2">
                    <Accordion.Header>কোর্সের কনটটেন্ট কি ফাইনাল?</Accordion.Header>
                    <Accordion.Body>
                ...
                <Accordion.Item eventKey="3">
                    <Accordion.Header>এই কোর্সে WordPress বা freelancing রিলেটেড সরাসরি কিছু আছে?</Accordion.Header>
                    <Accordion.Body>
